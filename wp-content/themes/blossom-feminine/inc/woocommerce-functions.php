...
function blossom_feminine_wc_sidebar_cb(){
    ...
    if( is_active_sidebar( 'shop-sidebar' ) && $post_layout != 'no-sidebar' ){
...
function blossom_feminine_wc_cart_count(){
    ...
    <div class="cart">                                   	
        <a href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_html_e( 'View your shopping cart', 'blossom-feminine' ); ?>">

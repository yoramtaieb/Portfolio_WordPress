...
<div id="help-panel" class="panel-left">
    ...
    <div class="panel-aside">
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://docs.blossomthemes.com/docs/' . BLOSSOM_FEMININE_THEME_TEXTDOMAIN . '/' ); ?>" title="<?php esc_attr_e( 'Visit the Documentation', 'blossom-feminine' ); ?>" target="_blank"><?php _e( 'View Documentation', 'blossom-feminine' ); ?></a>
    </div><!-- .panel-aside -->
    
    <div class="panel-aside">
        <h4><?php _e( 'Support Ticket', 'blossom-feminine' ); ?></h4>
        <p><?php printf( __( 'It\'s always a good idea to visit our %1$sKnowledge Base%2$s before you send us a support ticket.', 'blossom-feminine' ), '<a href="'. esc_url( 'https://docs.blossomthemes.com/docs/' . BLOSSOM_FEMININE_THEME_TEXTDOMAIN . '/' ) .'" target="_blank">', '</a>' ); ?></p>
    ...
    <div class="panel-aside">
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://demo.blossomthemes.com/' . BLOSSOM_FEMININE_THEME_TEXTDOMAIN . '/' ); ?>" title="<?php esc_attr_e( 'Visit the Demo', 'blossom-feminine' ); ?>" target="_blank"><?php _e( 'View Demo', 'blossom-feminine' ); ?></a>
    </div><!-- .panel-aside -->
</div>
